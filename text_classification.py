...
def getTheIMDBDataset():
	imdb = keras.datasets.imdb
	(train_data, train_labels), (test_data, test_labels) = imdb.load_data(num_words=10000)
	return (train_data, train_labels), (test_data, test_labels)

def convertTheNumbersToWords():
	imdb = keras.datasets.imdb
...
def exploreTheData(train_data, train_labels):
...
def main():
	(train_data, train_labels), (test_data, test_labels) = getTheIMDBDataset()

	exploreTheData(train_data, train_labels)
	reverse_word_index, word_index = convertTheNumbersToWords()
